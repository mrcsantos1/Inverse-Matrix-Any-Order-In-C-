/* Este algoritmo foi criado para fins educativos. Sua utilizção é livre, desde que usado 
*  para o crescimento e para a expansão do conhecimento 
*  da programação. 
*
*  Este algoritmo foi desenvolvido com o objetivo de alcançar a aprovação na discilpina 
